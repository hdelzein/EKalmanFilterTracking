...
exec_visualization = ['show_tracks','make_tracking_movie', ] # options are ['show_range , 'show_pcl , 'make_tracking_movie']
        ...
        if 'perform_tracking' in exec_list:
            ...
            if 'show_tracks' in exec_list:
                ...
                if 'make_tracking_movie' in exec_list:
                    ...
                    fname = results_fullpath + r'\frameImages' + r'\tracking%03d.png' % cnt_frame
...
if 'make_tracking_movie' in exec_list:
    make_movie(results_fullpath + r'\frameImages')
